    ...
    if (slashCount === 2) {
        ...
        if (dashCount == 2) {
            ...
            if (v1 == 2 && v2 == 2 && v3 >= 2) {
                ...
                const afterSlashSubAreaName = afterSlash.split('-').slice(2).join('-');
                const NumValue = await getCityContactByName(`${afterSlashCity}`);
                const isSubCityThere = await getCityByName(`${afterSlashCity}`);
        ...
        if (dashCount == 3) {
            ...
            if (v1 == 2 && v2 == 3 && v3 >= 2) {
                ...
                const isAreaFound = await getCityByName(`${afterSlashCity}2`, `${afterSlashAreaName}-${afterSlashSubAreaName}`);
